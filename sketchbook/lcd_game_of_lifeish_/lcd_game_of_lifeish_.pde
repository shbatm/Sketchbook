...
void loop(){
  ...
  //A delay, which we should really use and go for the way i done with checking for empty
  //field, it doesn't really matter now, since it's at the moment set to 0.
  delay(delayVal);
}
